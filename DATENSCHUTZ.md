# Datenschutzerklärung — Μαθαίνω (Griechisch A1)
...
Damit die App funktioniert, speichert sie folgende Daten
**ausschließlich lokal** im App-Datenverzeichnis des Geräts:

- **Lernfortschritt** (`progress.db`): Leitner-Box, richtig/falsch-Zähler
  und Fälligkeit je Vokabelkarte.
...
Die App fragt keine Standort-, Kontakt-, Kamera- oder
Mikrofon-Berechtigungen an.

## Ihre Rechte

Da die App keine personenbezogenen Daten erhebt oder an den Anbieter
übermittelt, entstehen beim Anbieter keine Datenbestände, auf die sich
Auskunfts-, Berichtigungs- oder Löschersuchen (Art. 15–21 DSGVO)
beziehen könnten. Unabhängig davon besteht das Recht auf Beschwerde bei
einer Datenschutz-Aufsichtsbehörde.

## Änderungen

Ändert sich der Funktionsumfang der App in datenschutzrelevanter Weise,
wird diese Erklärung entsprechend aktualisiert. Die jeweils aktuelle
Fassung liegt im Repository unter `DATENSCHUTZ.md`.
