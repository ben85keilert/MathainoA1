...
*(früherer Arbeitstitel: Pame! Trainer)*
...
## Hinweis zu Lehrbuchinhalten

Die App wird **ohne Vokabellisten ausgeliefert** — eigene Listen kommen
per Import (CSV/JSON-Datei oder „Als Text importieren") in die App; der
passende Chatbot-Prompt steht in der App-Hilfe. Lokale Listen liegen im
gitignorierten Ordner `private/` und kommen nie ins Repository.

Buch-PDFs und Buchlisten sind gitignoriert und nicht Teil dieses
Repositorys. Die MIT-Lizenz gilt nur für den Quellcode.

## Lizenz

MIT, siehe [LICENSE](LICENSE) — gilt für den Quellcode, **nicht** für
Lehrbuchinhalte (siehe oben).
